...
public enum WaitingErrorCode implements ErrorCode {
	...
	WAITING_NOT_FOUND("WAITING101", "해당 웨이팅은 존재하지 않습니다.", HttpStatus.NOT_FOUND),
	...
	STORE_NOT_FOUND("WAITING108", "해당 매장을 찾을 수 없습니다.", HttpStatus.BAD_REQUEST),
	EXTERNAL_SERVICE_ERROR("WAITING109", "외부 서비스 호출 중 오류가 발생했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
	INTERNAL_SERVER_ERROR("WAITING110", "서버 내부 오류가 발생했습니다.", HttpStatus.INTERNAL_SERVER_ERROR),
	INVALID_REQUEST("WAITING111", "잘못된 요청입니다.", HttpStatus.BAD_REQUEST);
