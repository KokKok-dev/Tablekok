...
public enum WaitingDomainErrorCode implements ErrorCode {
	...
	WAITING_DISABLED("WAITING12", "현재 매장에서 웨이팅 접수를 받고 있지 않습니다.", HttpStatus.BAD_REQUEST),
	NOT_OPERATING_HOURS("WAITING13", "영업 시간이 아닙니다. 웨이팅 접수가 불가능합니다.", HttpStatus.BAD_REQUEST);
