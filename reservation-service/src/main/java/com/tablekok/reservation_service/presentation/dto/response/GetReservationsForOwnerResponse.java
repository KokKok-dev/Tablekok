...
public record GetReservationsForOwnerResponse(
	...
	public static Page<GetReservationsForOwnerResponse> toPage(Page<Reservation> reservations) {
		return reservations.map(reservation -> GetReservationsForOwnerResponse.builder()
